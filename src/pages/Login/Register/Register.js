...
const Register = () => {
    ...
    return (
        ...
        <form className="flex flex-col bg-white rounded shadow-lg p-12 mt-12" action="" >
            ...
            <button className="flex items-center justify-center h-12 px-6 w-80 bg-gray-800 mt-8 rounded font-semibold text-sm text-blue-100 hover:bg-gray-900">Submit</button>
