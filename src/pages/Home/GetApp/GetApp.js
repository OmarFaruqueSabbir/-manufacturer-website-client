            ...
            <section class="bg-white dark:bg-gray-900">
                <div class="container flex flex-col items-center px-4 py-12 mx-auto xl:flex-row">
                    ...
                    <div class="flex flex-col items-center mt-6 xl:items-start xl:w-1/2 xl:mt-0">
                        ...
                        <p class="block max-w-2xl mt-4 text-xl text-gray-500 dark:text-gray-300 text-left">Download our mobile app version. Its more flexible to check, place order, get order status & info about upcoming stocks & offers.</p>

                        <div class="mt-6 sm:-mx-2">
                            <div class="inline-flex w-full overflow-hidden rounded-lg shadow sm:w-auto sm:mx-2">
                                <a href="#a" class="inline-flex items-center justify-center w-full px-5 py-3 text-base font-medium text-white bg-gradient-to-r from-gray-700 to-gray-900 hover:from-gray-600 hover:to-gray-600 sm:w-auto">
                            ...
                            <div class="inline-flex w-full mt-4 overflow-hidden rounded-lg shadow sm:w-auto sm:mx-2 sm:mt-0">
                                <a href="#a" class="inline-flex items-center justify-center w-full px-5 py-3 text-base font-medium text-white transition-colors duration-150 transform sm:w-auto bg-gradient-to-r from-orange-400 to-orange-500 hover:from-orange-600 hover:to-orange-600">
