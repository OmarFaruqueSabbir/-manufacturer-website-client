    ...
    return (
        <div>
            ...
            <div class="modal modal-bottom sm:modal-middle">
                <div class="modal-box">
                    <h3 class="font-bold text-lg text-red-600">Do you want to Cancel your Order?!</h3>
                    <p class="py-4">Pressing Delete button will remove your order from our records.</p>
